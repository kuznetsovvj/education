...
От "Комбинаторной оптимизации" приходится отказаться: практической пользы от неё никакой, а на занятия для собственного удовольствия не хватает времени.

- [ ] 5 решенных алгоритмических задач с codeforces
- [ ] 2 видео "Architecture Monday"
- [ ] Виленкин "Комбинаторика". Глава 1, § 16-17, задачи 43-64.
- [ ] Зорич "Математический анализ". Глава 1, § 2.
- [ ] Подготовка финальной версии презентации для "Панда митап"
