...
### [**Владимир Хориков - Validation & DDD, ArchDays 2021**](https://www.youtube.com/watch?v=mMo8G3gCOtA)

Различие подходов к валидации:

- always-valid domain model гарантирует всегда валидное состояние модели
- not-always-valid domain model позволит сделать категоризацию ошибок и делать валидацию внутри доменных классов

Минусы not-always-valid: нет уверенности, была ли уже сделана валидация или нет? Образуется временная связность, валидация становится не прозрачной, легко допустить ошибку.

Использование примитивных типов для моделирования доменных объектов - большая проблема, процесс валидации - это переход от примитивов к доменным объектам (value object - типы "обертки" над примитивными, включающими в себя валидации).

Value object:

- не имеют своей идентичности, своего уникального идентификатора
- неизменяемые
- всегда присоединены к какой-либо сущности
...
### [**Алексей Пименов "Рабочий процесс как процесс накопления знания", TeamLead Conf 2022**](https://www.youtube.com/watch?v=ux4Gl234qMk&list=PL_L_HiHe5k_2sEh1wpJUQoEoTDjqralLV&index=4)
