...
| | [Юрий Власов, Тимофей Нецветаев - Кролик по-СДЭКовски: RabbitMQ как основной центр обмена данными](https://www.youtube.com/watch?v=-q0aSAV1iT0&list=PLH-XmS0lSi_z45jTyyS4ZebvZnNWbhO4K&index=125) | Опыт использования RabbitMQ: 8 нод, отказ от HA-cluster, "почему не Kafka?" |
| | [Константин Осипов - Алгоритм управления распределенными транзакциями Accord](https://www.youtube.com/watch?v=DS5yuSuavbk&list=PLH-XmS0lSi_z45jTyyS4ZebvZnNWbhO4K&index=110) | Протокол Accord, предложенный в экосистеме Cassandra |
